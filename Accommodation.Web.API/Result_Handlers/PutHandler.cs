...
{
    public class PutHandler<T> : BaseHandler<T>
    {
        public PutHandler(bool responseData, HttpRequestMessage request)
        {
            try
            {
                ...
                HttpStatusCode = responseData ? System.Net.HttpStatusCode.OK : System.Net.HttpStatusCode.NotImplemented;
                Content = response;
                Request = request;
            }
            catch (Exception ex)
